...
#define VERBOSE             (LOG_MAIN_REG_READS | LOG_MAIN_REG_WRITES | LOG_STATUS | LOG_ICA)
#include "logmacro.h"
	...
	for (int i = 0; i < max_to_process; i++)
	{
		...
		switch ((cmd & 0xff000000) >> 24)
		{
			...
			case 0x48: case 0x49: case 0x4a: case 0x4b: case 0x4c: case 0x4d: case 0x4e: case 0x4f:
				LOGMASKED(LOG_MAIN_REG_WRITES, "%08x: %08x: ICA %d: RELOAD VSR: %06x\n", (addr - 2) * 2 + Channel * 0x200000, cmd, Channel, cmd & 0x001fffff );
			...
			case 0x58: case 0x59: case 0x5a: case 0x5b: case 0x5c: case 0x5d: case 0x5e: case 0x5f:
				LOGMASKED(LOG_MAIN_REG_WRITES, "%08x: %08x: ICA %d: RELOAD VSR and STOP: VSR = %05x\n", (addr - 2) * 2 + Channel * 0x200000, cmd, Channel, cmd & 0x001fffff );
